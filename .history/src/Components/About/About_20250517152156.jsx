        ...
        <div className="about-right">
          <div className="about-para">
            <p>
              ...
              CSS, and React.{" "}
              <p>
                With a strong passion for web development and design, I actively
                work on hands-on projects. I'm also a DSA enthusiast,
                continuously improving my problem-solving skills in Java and
                JavaScript.
                <p>
                  Completed my Intermediate with a remarkable 94% Achieved a
                  CGPA of 10 in school
                </p>
              </p>
            </p>
          </div>
